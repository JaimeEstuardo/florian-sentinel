    ...
    <div className="space-y-8">
      <div className="flex justify-between items-end border-b border-zinc-800 pb-8">
        <div>
          ...
          <p className="text-[10px] text-zinc-500 font-mono uppercase mt-3 tracking-[0.3em]">
        ...
        <div className="hidden md:flex bg-zinc-900/30 border border-zinc-800 px-4 py-2 items-center gap-3">
           ...
           <span className="text-[10px] font-mono text-[#008ed6] uppercase tracking-widest">Radar_Activo</span>
        </div>
      </div>
